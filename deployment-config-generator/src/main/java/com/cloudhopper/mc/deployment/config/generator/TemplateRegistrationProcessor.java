...
import com.cloudhopper.mc.deployment.config.api.GeneratorConfig;
...
@SupportedAnnotationTypes("com.cloudhopper.mc.deployment.config.api.GenericDeploymentConfigGenerator.TemplateRegistration")

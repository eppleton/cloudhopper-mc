package eu.cloudhopper.mc.test.system.tests.generator.aws.terraform;
...
import eu.cloudhopper.mc.generator.bindings.aws.terraform.TestContextAws;
...
public class TckLauncher {
    public static void main(String[] args) throws Exception {
        CompatibilityTestRunner.runWith("aws-terraform-java21", new TestContextAws());
    }
}
